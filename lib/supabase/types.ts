  ...
  public: {
    Tables: {
      ...
      game_mode_match_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_mode_match_rules_mode_id_fkey"
            columns: ["mode_id"]
            isOneToOne: false
            referencedRelation: "game_modes"
            referencedColumns: ["id"]
      ...
      lobby_entrants: {
        ...
        Relationships: [
          {
            foreignKeyName: "lobby_entrants_entrant_id_fkey"
            columns: ["entrant_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "lobby_entrants_lobby_id_fkey"
            columns: ["lobby_id"]
            isOneToOne: false
      ...
      lobby_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "lobby_results_entrant_id_fkey"
            columns: ["entrant_id"]
            isOneToOne: false
            referencedRelation: "tournament_entrants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lobby_results_lobby_id_fkey"
            columns: ["lobby_id"]
            isOneToOne: false
            referencedRelation: "tournament_lobbies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lobby_results_submitted_by_fkey"
            columns: ["submitted_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "lobby_results_verified_by_fkey"
            columns: ["verified_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      tournament_registrations: {
        ...
        Relationships: [
          {
            foreignKeyName: "tournament_registrations_entrant_id_fkey"
            columns: ["entrant_id"]
            isOneToOne: false
            referencedRelation: "tournament_entrants"
            referencedColumns: ["id"]
      ...
      tournaments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tournaments_match_rule_id_fkey"
