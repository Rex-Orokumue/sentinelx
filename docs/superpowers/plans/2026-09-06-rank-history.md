...
**Files:**
- Create: `supabase/migrations/20260906152919_player_rank_snapshots.sql`
...
```bash
git add supabase/migrations/20260906152919_player_rank_snapshots.sql lib/supabase/types.ts
