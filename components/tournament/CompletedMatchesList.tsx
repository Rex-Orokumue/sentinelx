...
import type { CompletedMatchRow } from '@/lib/matches/completed-matches'
        ...
        const Row = (
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-500">
              ...
              {formatDateTime(m.completedAt) ? ` · ${formatDateTime(m.completedAt)}` : ''}
            </p>
          </div>
        )
        return href ? (
