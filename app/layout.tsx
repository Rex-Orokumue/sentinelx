          ...
          <header className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950/90 backdrop-blur-sm">
            <nav className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
              <Link href="/" className="flex items-center gap-2">
                <Image src="/logo-icon.png" alt="Sentinel X" width={36} height={36} priority />
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                <Link
                  href="/rankings"
                  className="hidden rounded-lg px-3 py-1.5 text-sm text-slate-300 transition-colors hover:bg-slate-800 hover:text-white sm:block"
                >
                  Rankings
                </Link>
                <a
